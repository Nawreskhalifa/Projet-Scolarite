...
<body>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="SemAb" name="SemAb" min="1" max="6" value="<?php echo $semAb; ?>">
                    </div>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', initializeDateConstraints);
        document.getElementById('Annee').addEventListener('change', initializeDateConstraints);
        document.getElementById('Sem').addEventListener('change', initializeDateConstraints);
        document.getElementById('Debut').addEventListener('change', initializeDateConstraints);
        document.getElementById('Fin').addEventListener('change', initializeDateConstraints);
        document.getElementById('Debsem').addEventListener('change', initializeDateConstraints);
        document.getElementById('Finsem').addEventListener('change', initializeDateConstraints);
        document.getElementById('Annea').addEventListener('change', initializeDateConstraints);
        document.getElementById('Anneab').addEventListener('change', initializeDateConstraints);
        document.getElementById('SemAb').addEventListener('change', initializeDateConstraints);
